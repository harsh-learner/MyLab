...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Harsh DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" role="button">Project!! complete &raquo;</a></p>
    </div>
</div>
...
<div class="container">
    ...
    <footer>
        <p>&copy; harsh devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
